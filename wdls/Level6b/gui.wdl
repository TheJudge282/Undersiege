...
// my.skill1 += ToNumberBut( my.skill1, my.skill2, 2);
 ...
 my.roll = camera.pan; //my.skill5 + sin(my.skill3) * my.skill4;
 if (EnemyPos.visible)
 {
...
{ return;}
	...
	while (key_pressed(lkey)==1)
	{
		...
		MisionsMsg2.alpha  = missionsbk.alpha;
		MisionsMsg3.alpha  = missionsbk.alpha;
		MisionsMsg4.alpha  = missionsbk.alpha;
		MisionsMsg5.alpha  = missionsbk.alpha;
		MisionsMsg6.alpha  = missionsbk.alpha;
		MisionsMsg7.alpha  = missionsbk.alpha;
		MisionsMsg8.alpha  = missionsbk.alpha;
		missionsbk.y = max( 3.75, missionsbk.y-5);
		MisionsMsg1.y = missionsbk.y;
		MisionsMsg2.y = missionsbk.y;
		MisionsMsg3.y = missionsbk.y;
		MisionsMsg4.y = missionsbk.y;
		MisionsMsg5.y = missionsbk.y;
		MisionsMsg6.y = missionsbk.y;
		MisionsMsg7.y = missionsbk.y;
		MisionsMsg8.y = missionsbk.y;
		wait(1);
	}
