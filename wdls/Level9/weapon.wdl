...
function sprite_weapon()
{
	...
	{		
		VWeaponSprite.scale_y = -0.028;		
		VWeaponSprite_U.visible = 1;
		VWeaponSprite.skin  = 10;
		VWeaponSprite_U.skin = 13;
	}
	else
	{
		VWeaponSprite.scale_y = -0.028;	
		VWeaponSprite_U.visible = 0;
	}
	...
	if (SpriteWeapon == 1)  /* sprite weapon */
	{
		...
		{			
			while (i < 100)
			{
				...
				set_frame( VWeaponSprite_U, lu, i);
				wait(1);
				if (eplhealth){	return;	}
			}
...
{     		
	...
	if (my._ammotype == gurnade)||(my._ammotype == gasgurnade)                { return;	}
...
/////////////////////////////////////////////////
	...
	if (weapon_number == Doubleuzi)
	{
		//VWeaponSprite.y = -2.5	+ (weapon.skill30 - CamraPan.roll*abs(1.125+sin(CamraPan/2)*0.2))*0.1 + 2; 
		VWeaponSprite_U.y = -2.5	+ (weapon.skill30 - CamraPan.roll*abs(1.125+sin(CamraPan/2)*0.2))*0.1 + 4;
	}
	else
	{
