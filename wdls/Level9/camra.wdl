...
{ 
   me = s;
	...
	camera.pan = my.pan + iCameraAngles.pan;
	camera.tilt = (my.MyTilt*115/85)-70 + iCameraAngles.tilt;
	camera.roll = iCameraAngles.roll;//0;//sin(CamraPan)/2;
	if (camera.arc!=60)
	{
