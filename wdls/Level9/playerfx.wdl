...
{	
	...
	if (my.skill6 == 1) { 	play_entsound(me ,BGlas1 , __BreakVol);	SoundHolder = result;	goto GG1; }	
	if (my.skill6 == 2) { 	play_entsound(me ,BGlas2 , __BreakVol);	SoundHolder = result;	goto GG1; }	
	if (my.skill6 == 3) { 	play_entsound(me ,BGlas3 , __BreakVol);	SoundHolder = result;	goto GG1; }	
	if (my.skill6 == 4) { 	play_entsound(me ,BGlas4 , __BreakVol);	SoundHolder = result;	goto GG1; }
	if (my.skill6 == 5) { 	play_entsound(me ,BGlas5 , __BreakVol);	SoundHolder = result;		  }

	GG1:

	while (snd_playing(SoundHolder))
	{
	wait(1);
	}
	remove(me);
