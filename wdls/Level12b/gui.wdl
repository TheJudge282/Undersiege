...
if (missionsbk.visible )||(camera.arc != 60)
{ return;}
...
function ShowMessionsAuto()
{
	...
	if (freeze_mode || eplhealth){return;}
	missionsbk.y = 10.75;
	if (missionsbk.visible == 1)||(camera.arc != 60)
	{return;
	}
	missionsbk.visible = 1;
	missionsbk.alpha = 0;
