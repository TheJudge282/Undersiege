...
function BigBlacksmoke_Trail() {
	...
	my.alpha=100;
	my.lifespan=100;
	my.function=Blacksmoke_property;
}

function Black_smoke2up() {
	my.move=0;
	my.size=random(25)+25;
	my.bmap = AtomSmoke;
	my.flare=on;
	my.transparent=on;
	my.alpha=100;
...
function HugeSmoke(Angl)
{
			temp.x = 100+my.skill1*2.5;
			temp.y = 0;
			temp.z = 0;
			my_angle.x = my.pan+Angl;
			my_angle.y = my.tilt+45-random(45);
			...
			my_angle.y =  0;
			my_angle.z =  0;
			effect( PartsThrow, 1, temp, my_angle);
...
function Black_smokeup_property2() {
if (freeze_mode)
{
...
else
{
	...
	my.x += my.vel_x*speed/50*explosionscale;
	my.y += my.vel_y*speed/50*explosionscale;
	my.z += my.vel_z*speed/50*explosionscale;
	temp.x = my.red   ;
	temp.y = my.green ;
	temp.z = my.blue  ;
...
function Black_smokeup2() {
	my.size=60+random(50);
	my.bmap=AtomSmoke;
	my.red = my.vel_x;
	my.green = my.vel_y;
	my.blue = my.vel_z;
	...
	my.move=0;
	my.alpha=60+random(40);
	my.function=Black_smokeup_property2;
}
...
function BlackMinismokeup() {
	my.size=(200+random(50))*explosionscale;
	my.bmap= FireAtome;
	my.bright = 1;
	my.move=0;
	my.alpha=60+random(40);
...
while(vec_dist(my.skill1,my.skill4)>1)
{
	...
	{
	effect(Black_smokeup2,1,my.skill1,my.skill10);
	}
