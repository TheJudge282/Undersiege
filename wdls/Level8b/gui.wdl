...
function ZoomGui()
{
	...
	HldBk.x =   Compass.x;
	AHldBk.z = WeaponStore.z + 0.5;
	AHldBk.x =   Compass.x;
	
	vec_set( HldSld.pos, HldBk.pos);
	vec_set( AHldSld.pos, AHldBk.pos);
