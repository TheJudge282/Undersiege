...
entiy = me;
var dist;
dist = ((vec_dist(player.pos,my.pos)-1000)/200)+17;
//if (vec_dist(player.pos,my.pos) < 1000)
//{	
	you = my.RightWheel;
	you.EnemyId = my.EnemyId;
	me = my.RightWheel;
	MalalehDamege(50,1,1,50);

/*}else
{
	me = my.LeftWheel;
	my.mytilt = entiy.cartarget_y*0.25+(220+dist);
...
/*	if (you!=0)
	{
		if ((you.ownlife<=-100)||(vec_dist(you.pos,my.pos)>5000))
		{
			my.EnemyId=0;
			you=0;
		}
