...
var iPlayerdamage = 3;
function ShotAndDamage2(RandDist,Line,Hole,Vnum)
{
...
//	}
	...
	trace( temp, you.pos);
	res = you == Pointer_To_Entity( my.EnemyId);
	if (res==0)
	{
	you = Pointer_To_Entity( my.EnemyId);
	vec_set( temp2, you.pos);
	temp2.z+=you.max_z*0.90;
	trace( temp, temp2);
	res = you == Pointer_To_Entity( my.EnemyId);
	}
	return(res);
...
{	
	...
	vec_set(ScanValues[scan_x],my.x);
	ScanValues[scan_SPan] = my.pan+90;
	ScanValues[scan_EPan] = 180;
	ScanValues[scan_Range] = 1000;
