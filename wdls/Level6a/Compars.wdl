...
{
/*if (	my._type != _type_player1)
{
	my._health-=10;
}*/
if (	GazPazokanum.y == -100)&&(my._type != _type_player1)
{
	my._health-=10;
}
	if (my._health <=-200)
...
function SolderDie()
{
	...
	if (level.z == 1)
	{
		if (SolderCounter < 3)&&(Game_State[0] == 1)
		{
			if (Game_State[1] == 1)// right side
			{
				Game_State[1]=2;
				GroupExist=0;
				goto OutFromHere;
		...
		if (Game_State[0] == 1)&&(SolderCounter < 1)//Group one 
		{
			if (Game_State[1] == 2)// back side
			{
				Game_State[1]=3;
				GroupExist=0;
				goto OutFromHere;
			}
			if (Game_State[1] == 3)// both front side
			{
				Game_State[0]=2;
				GroupExist=0;
				goto OutFromHere;
		...
		if (Game_State[0] == 2)&&(SolderCounter < 1)// both front & back side
		{
			Game_State[0]=3;
			GroupExist=0;
			goto OutFromHere;
		}
/*		if (Game_State[0] == 3)&&(SolderCounter < 1)// airforce one
		{
			Game_State[0]=4;
			GroupExist=0;
			goto OutFromHere;
		}*/
/*		if (Game_State[0] == 6)&&(SolderCounter < 1)// airforce two
		{
			Game_State[0]=7;
			GroupExist=0;
			goto OutFromHere;
		}*/
		if (Game_State[0] == 7)&&(SolderCounter < 1)// airforce three
		{
			Game_State[0]=8;
			GroupExist=0;
			goto OutFromHere;
		}
		if (Game_State[0] == 8)&&(SolderCounter < 1)// the end
		{
			Game_State[0]=9;
			GroupExist=0;
			goto OutFromHere;
