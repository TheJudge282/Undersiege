...
if freeze_mode == 0 {
	...
	my.size=vec_dist(my.x,camera.x)/5;
...
function dustmerain()
{
	...
	if (raining==0)  {return;}
	if (my.force<10) {return;}
		temp.x=(my.force+random(my.force))*10;
		temp.y=random(100)-50;
		temp.z=random(100)-50;
		vec_rotate( temp, my.pan);

		temp2.x=(-my.force+random(my.force/5))*2;
		temp2.y=0;
		temp2.z=0;
