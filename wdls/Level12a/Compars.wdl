...
function SoldCheckIfHealthy()
{
	...
	if (game_state[0] > 4)&&(game_state[0] < 100)
	{my._health = -1000;
	}
	if (my._health <=-200)
	{
...
/////////////////////////////////////////////////////////////////////////////////////////////
//for level 12
function check_For_Soldiers_num()
{	
	if (SolderCounter < 4)&&(Game_State[0] == 1)
	{
		if (Game_State[1] == 1)// Second group
		{
			Game_State[1]=2;
			GroupExist=0;
			goto endchek;
	...
	if (Game_State[0] == 1)&&(SolderCounter < 4)
	{
		if (Game_State[1] == 2)// Third group
		{
			Game_State[1]=3;
			GroupExist=0;
			goto endchek;
	...
	if (Game_State[0] == 1)&&(SolderCounter < 2)
	{
		if (Game_State[1] == 3)// Show Explosion
		{
...
function SolderDie()
{
if (my.weaponnumber != lmg)&&(my.weaponnumber != s99sniper )
{SolderCounter-=1;
}
check_For_Soldiers_num();
DedSolders+=1;
wait(1);
you = Pointer_To_Entity( my.EnemyId);
if (you)
...
RemoveColl(me);
 ...
 while (my.skill1<100)
  ...
  {		if (my.weaponnumber == 4)&&(int(random(100))> 95)
		{
